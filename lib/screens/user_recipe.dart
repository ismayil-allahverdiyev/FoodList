...
class UserRecipe extends StatefulWidget {
  ...
  UserRecipe(this.detail, {Key? key}) : super(key: key);
  @override
  State<UserRecipe> createState() => _UserRecipeState();
}

class _UserRecipeState extends State<UserRecipe> with SingleTickerProviderStateMixin{
  ...
  getIngredients() async{
    ...
    if(widget.detail!.cuisine !="choose") {
      print("cuisine ran");
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          GestureDetector(
                            onTap: (){
                              Share.share(widget.detail!.title!, subject: "Check out this recipe!");
                            },
                            child: Container(
                              child: Text(
                                  "Click to share!",
